        ...
        <ul>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li class="caution">The order of the routes is very important! If the blog_show route were
                        placed above the blog route, the URL /blog/2 would match blog_show instead of blog since
                        the {slug} parameter of blog_show has no requirements.</li>
                </ul>
            </li>
            <li>
            ...
            <li>
                ...
                <ol>
                    <li>"_controller": used to determine which controller is executed when the route is  matched.</li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        in JavaScript based on your routing configuration. By using the <a href="https://github.com/FriendsOfSymfony/FOSJsRoutingBundle" target="_blank">FOSJsRoutingBundle</a>, you can do
                        exactly that:
