<section class="wiki-article">
    <div class="wiki-article-title">
        <h1 class="btnShowHideArticleBody" data-article-visibility="off">Creating and using templates<h1>
    </div>
    <div class="wiki-article-body invisible">
        <ul>
            <li>
                <h2>Why use twig?</h2>
                <ul>
                    <li>Twig templates are meant to be simple and won't process PHP tags. This is by design: the Twig
                        template system is meant to express presentation, not program logic.</li>
                    <li>Twig can also do things that PHP can't, such as whitespace control, sandboxing, automatic HTML
                        escaping, manual contextual output escaping, and the inclusion of custom functions and filters
                        that only affect templates.</li>
                    <li>Twig is fast. Each Twig template is compiled down to a native PHP class that is rendered at runtime. The
                        compiled classes are located in the app/cache/{environment}/twig directory (where {environment}
                        is the environment, such as dev or prod) and in some cases can be useful while debugging.</li>
                    <li>When debug mode is enabled (common in the dev environment), a Twig template will be automatically
                        ...
                        cache.</li>
                    <li class="caution">When debug mode is disabled (common in the prod environment), however, you must clear the Twig
            ...
            <li>
                ...
                <ul>
                    <li>{{ ... }}: prints a variable or the result of an expression to the template.</li>
                    <li>{% ... %}: controls the logic of the template; it is used to execute statements such
                    as for-loops for example.</li>
            ...
            <li>
                ...
                <ul>
                    <li>
                        ...
                        <ul>
                            <li>"app/Resources/views/": The applications views directory can contain application-wide base templates (i.e. your
                                application's layouts and templates of the application bundle) as well as templates that override
                                third party bundle templates.</li>
                            <li>"path/to/bundle/Resources/views/": Each third party bundle houses its templates in its Resources/views/ directory (and
                                subdirectories). When you plan to share your bundle, you should put the templates in the bundle
                                instead of the app/ directory.</li>
                        </ul>
                    </li>
                    <li>
                        Referencing Templates in a Bundle
                        <ul>
                            <li>Symfony uses a <strong>bundle:directory:filename.format.engine</strong> syntax for templates that live inside "src/bundle/Resources/views/directory/filename.format.engine".</li>
                            <li>Symfony uses a <strong>bundle::filename.format.engine</strong> syntax for templates that live inside "src/bundle/Resources/views/filename.format.engine".</li>
                        </ul>
                    <li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul>
                    <li>
                        Controllers can be embedded asynchronously using the <a href="ttp://mnot.github.com/hinclude/" target="_blank" >hinclude.js</a> JavaScript library.
                        <?php include "code/symfony_code_45.txt"; ?>
                    </li>
                    <li>
                        When using a controller instead of a URL, you must enable the Symfony <strong>fragments</strong> configuration:
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>
                        Include assets located in your bundles' <strong>Resources/public</strong> folder
                        <?php include "code/symfony_code_52.txt"; ?>
                        <ul>
                            <li class="caution">You will need to run the
                                "php app/console assets:install target [--symlink]" command, which moves (or symlinks) files
                                into the correct location. (target is by default "web").</li>
                        </ul>
                    </li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul>
                    <li>
                        Symfony always starts by looking in the <strong>app/Resources/{BUNDLE_NAME}/views/</strong> directory for a template. If the template doesn't exist there, it continues by
                        checking inside the <strong>Resources/views</strong> directory of the bundle itself. This means that all bundle templates
                        can be overridden by placing them in the correct <strong>app/Resources</strong> subdirectory.
                    </li>
                    <li>
                        Example: Customize 404 Twig error page
                        <ul>
                            <li>
            ...
            <li>
                ...
                <ul>
                    <li>If you're using Twig, output escaping is on by default and you're protected.</li>
                    <li>
            ...
            <li>
                <h2>Debugging</h2>
                <ul>
                    <li>When using PHP, you can use the <strong>dump()</strong> function from the VarDumper component if you need to quickly
                        find the value of a variable passed.</li>
                    <li>
                        In Twig:
                        <?php include "code/symfony_code_57.txt"; ?>
                    </li>
                    <li class="caution">The variables will only be dumped if Twig's <strong>debug</strong> setting (in config.yml) is true. By default this means
                        that the variables will be dumped in the dev environment but not the prod environment</li>
                </ul>
            </li>
            <li>
