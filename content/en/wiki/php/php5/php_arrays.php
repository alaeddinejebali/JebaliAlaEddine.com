<section class="wiki-article">
    <div class="wiki-article-title">
        <h1 class="btnShowHideArticleBody" data-article-visibility="off">Arrays<h1>
    </div>
    <div class="wiki-article-body invisible">
        <ul>
                ...
                <ul>
                    ...
                    <li>Search element
                        <ul>
                            ...
                            <li>in_array($tab, v): checks if tab contains v or not. returns true or false.</li>
                            <li>
                    ...
                    <li>When an element is added to an array without specifying a key, PHP automatically assigns a numeric one that is equal to the greatest numeric key already in existence in the array, plus one:
                        <ul>
                            <li>Example:
                            ...
                            <li>Note that this is true even if the array contains a mix of numerical and string keys:
                                ...
                                <ul>
                                    <li>Note that array keys are case-sensitive, but type insensitive. Thus, the key 'A' is different from the key 'a', but the keys '1' and 1 are the same.</li>
                                    <li>The conversion is only applied if a string key contains the traditional decimal representation of a number; thus, for example, the key '01' is not the same as the key 1.</li>
                                </ul>
                            </li>
                        </ul>
                    </li>
            ...
            <li>
                ...
                <ul>
                    <li>While both functions recursively print out the contents of composite value</li>
                    ...
                    <li>Only print_r can return its output as a string, as opposed to writing it to the script's standard output.</li>
                </ul>
            </li>
            <li>
                <h2>Enumerative vs Associative</h2>
                <ul>
                    <li>Arrays can be roughly divided in two categories: enumerative and associative.
                        <ol>
                            <li>Enumerative arrays are indexed using only numerical indexes.<em>(fr: tableaux num&eacute;rot&eacute;s)</em></li>
                            <li>Asociative arrays (sometimes referred to as dictionaries) allow the association of an arbitrary key to every element. <em>(fr: tableaux associatifs)</em></li>
                        </ol>
                    </li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>The equivalence operator == returns true if both arrays have the same number of elements with the same values and keys, regardless of their order.</li>
                ...
                <ul>
                    ...
                    <li>array_reverse($array):
                        <ul>
                            ...
                            <li class="caution"> Note how key key association is only lost for those elements whose keys are numeric.</li>
                        </ul>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul>
                    <li>Each array has a pointer that indicates the current element of an array in an iteration.</li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>Both sort() and asort() accept a second, optional parameter:
                        <ol>
                            <li>SORT_REGULAR: Compare items as they appear in the array, without performing any kind of conversion. This is the default behaviour.</li>
                            <li>SORT_NUMERIC: Convert each element to a numeric value for sorting purposes.</li>
                            <li>SORT_STRING: Compare all elements as strings.</li>
                        </ol>
                    </li>
                    <li>To sort them in descending order, you can use rsort() and arsort().</li>
                    ...
                    <li>You can sort by key (rather than by value) using: ksort() and krsort()</li>
                    <li>To randomize elements of array, use: shuffle($array). You'll lost all keys and will be replaced from zero to n.</li>
                </ul>
            </li>
            <li>
                ...
                <ul>
                    <li>Stacks (LIFO)
                        <ul>
                            <li>array_push($array, $val): add at the end</li>
                            <li>array_pop($array): remove the last element</li>
                        </ul>
                    </li>
                    <li>Queues (FIFO)
                        <ul>
                            <li>array_unshift($array, $val): add at the beginning</li>
                            <li>array_shift($array): remove the first element</li>
                        </ul>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul>
                    <li>array_diff ($a, $b)): returns all the values of $a that do not appear in $b.</li>
                    <li>array_intersect ($a, $b)): returns all values that are included in both arrays.
