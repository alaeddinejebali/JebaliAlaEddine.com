<section class="wiki-article">
    <div class="wiki-article-title">
        <h1 class="btnShowHideArticleBody" data-article-visibility="off">Functions<h1>
    </div>
    <div class="wiki-article-body invisible">
        <ul>
            <li>
                ...
                <ul>
                    <li>PHP has three variable scopes: the global scope, function scope, and class scope.</li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>func_get_arg(2): returns the value of argument passed in parameter</li>
                </ul>
                <ul>
                    ...
                    <li>This does not cause any errors to be emitted, but it also makes no sense whatsoever because you
                        will never be able to omit the first parameter ($optional) if you want to specify the second,
                        and you can't omit the second because PHP will emit a warning.
                    </li>
                    <li>
