	...
	<div class="wiki-article-body invisible">
		<ul>
			<li>
				<h2>Introduction</h2>
				<ul>
					<li>Git has the ability to tag specific points in history as being
						important.</li>
					<li>Typically people use this functionality to mark release points
						(v1.0, and so on).</li>
					<li>Tags functionalities are similar to branches.</li>
					<li>Tags are independants from branches: when you are on branch
						develop and add a Tag, when you switch to master branch you'll see
						this Tag too.</li>
					<li>By default, the git push command doesn't transfer tags to
						remote servers. See <a href="#pushTags">Push Tags</a>
					</li>
					<li>By default, when creating a tag, it'll be assigned to <u>last
							commit</u>... but GIT offers the ability of <a
						href="#taggingLater">Tagging later</a>.
					</li>
				</ul>
			</li>
			<li>
				...
				<ul>
					...
					<li>This command lists the tags in alphabetical order. The order in
						which they appear has no real importance.</li>
				</ul>
			</li>
			<li>
