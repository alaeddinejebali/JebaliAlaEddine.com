<div class="panel panel-default wiki-article">
	<div class="panel-heading wiki-article-title">
		<h4 class="panel-title">
        	<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#controller">Controller</a>
		</h4>
	</div>
	<div id="controller" class="panel-collapse collapse">
		...
		<ul>
			...
			<li>
				...
				<ul>
					<li>If you want to create a static page (like 'terms and services'
						page), you don't need a controller</li>
				</ul>
			</li>
		</ul>	
		</div>
